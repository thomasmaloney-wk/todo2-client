...
UiFactory<TodoListFilterSidebarProps> TodoListFilterSidebar =
    _$TodoListFilterSidebar; // ignore: undefined_identifier

mixin TodoListFilterSidebarPropsMixin on UiProps {}

class TodoListFilterSidebarProps = UiProps
    with
        FluxUiPropsMixin<TodoActions, TodoStore>,
        TodoListFilterSidebarPropsMixin;
